...
public class CalculadoraMultidimensional extends JFrame {
    ...
    private void initComponents() {
        ...
        btnConvertir.setFont(new Font("Arial", Font.BOLD, 13));
        ...
        btnProcedimiento.setFont(new Font("Arial", Font.PLAIN, 13));
    ...
    private void setupLayout() {
        ...
        panelTitulo.setPreferredSize(new Dimension(580, 50));
        ...
        lblCreditos.setFont(new Font("Arial", Font.ITALIC, 10));
